...
def main():
    ...
    try:
        ...
        put_authenticate = requests.put('http://rest-server-h5si5ezrea-uc.a.run.app/authenticate', json=put_authenticate_req)
        print('\nPUT_AUTHENTICATE RESPONSE CODE: ',str(put_authenticate.content),'\n')
        count += 1
    except:
    ...
    try:
        ...
        post_pkg_url_resp = requests.post('http://rest-server-h5si5ezrea-uc.a.run.app/package', json=post_pkg_url)
        print('\nPOST PKG 1 RESPONSE CODE: ',str(post_pkg_url_resp.content),'\n')
        count += 1
    except:
    ...
    try:    
        ...
        put_package_id_resp = requests.put('http://rest-server-h5si5ezrea-uc.a.run.app/package/id', json=put_package_id)
        print('\nPUT PKG ID RESPONSE CODE: ',str(put_package_id_resp.content),'\n')
    ...
    #get /package/id
    try:
        get_package_id_resp = requests.get('http://rest-server-h5si5ezrea-uc.a.run.app/package/tbd')
        print('\nGET PKG ID RESPONSE CODE: ',str(get_package_id_resp.content),'\n')
    ...
    #get /package/id/rate
    try:
        get_package_id_rate_resp = requests.get('http://rest-server-h5si5ezrea-uc.a.run.app/package/tbd/rate')
        print('\nGET PKG ID RATE RESPONSE CODE: ',str(get_package_id_rate_resp.content),'\n')
    ...
    try:
        ...
        post_pkg_base64_resp2 = requests.post('http://rest-server-h5si5ezrea-uc.a.run.app/package', json=post_pkg_base642)
        print('\nPOST PKG B64 AXIOS RESPONSE CODE: ',str(post_pkg_base64_resp2.content),'\n')
    ...
    try:
        ...
        print('\nPOST PKGS RESPONSE CODE: ',str(post_pkgs.content),'\n')
    ...
    try:
        get_package_name_resp = requests.get('http://rest-server-h5si5ezrea-uc.a.run.app/package/byName/axios')
        print('\nGET PKG BYNAME RESPONSE CODE: ',str(get_package_name_resp.content),'\n')
    ...
    try:
        delete_package_name_resp = requests.delete('http://rest-server-h5si5ezrea-uc.a.run.app/package/byName/cloudinary')
        print('\nDEL PKG BYNAME RESPONSE CODE: ',str(delete_package_name_resp.content),'\n')
    ...
    #delete /package/id
    try:
        delete_package_id_resp = requests.delete('http://rest-server-h5si5ezrea-uc.a.run.app/package/tbd')
        print('\nDEL PKG BY ID RESPONSE CODE: ',str(delete_package_id_resp.content),'\n')
    ...
    try:
        ...
        post_pkg_url_resp2 = requests.post('http://rest-server-h5si5ezrea-uc.a.run.app/package', json=post_pkg_url2)
        print('\nPOST PKG URL2 RESPONSE CODE: ',str(post_pkg_url_resp2.content),'\n')
    ...
    #delete /reset
    try:
        delete_reset_resp = requests.delete('http://rest-server-h5si5ezrea-uc.a.run.app/reset')
        print('\nDELETE RESET RESPONSE CODE: ',str(delete_reset_resp.content),'\n')
